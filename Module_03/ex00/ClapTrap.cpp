...
/*   Updated: 2025/03/26 15:45:19 by lbenatar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "No more energy / health to attack." << std::endl;
		return ;
	}
	this->m_stamina--;
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->m_health <= 0)
	{
		std::cout << "No more health." << std::endl;
		return ;
	}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->m_stamina <= 0 || this->m_health <= 0)
	{
		std::cout << "No more energy / health to repair oneself." << std::endl;
		return ;
	}
	this->m_health += amount;
	this->m_stamina--;
